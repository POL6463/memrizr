...
func TestSignin(t *testing.T) {
	...
	t.Run("Bad request data", func(t *testing.T) {
		// a response recoder for getting written http response
	...
	t.Run("Error Returned from UserService.Signin", func(t *testing.T) {
		...
		// create a request body with validate fields
		reqBody, err := json.Marshal(gin.H{
			"email": email,
			"password": password,
		})
		...
		mockTokenService.AssertNotCalled(t, "NewTokenFromUser")
